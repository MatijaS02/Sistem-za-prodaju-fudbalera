...
public class FormaKonfiguracijaPort extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(31, 31, 31)
                .addComponent(jTextFieldPort, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButtonSacuvajActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSacuvajActionPerformed
        ...
        try{
            ...
            JOptionPane.showMessageDialog(this,"Pogresno unet port!","GRESKA",JOptionPane.ERROR_MESSAGE);
            return;
        }
        if(port>=0 && port<=65535){
            konfiguracija.Konfiguracija.getInstance().setProperty("port",port+"");
            konfiguracija.Konfiguracija.getInstance().sacuvajIzmene();
            JOptionPane.showMessageDialog(this,"Parametar je sacuvan!","OBAVESTENJE",JOptionPane.INFORMATION_MESSAGE);
        }
